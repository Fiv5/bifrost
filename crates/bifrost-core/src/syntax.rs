...
fn get_protocol_description(protocol: Protocol) -> &'static str {
    match protocol {
        ...
        Protocol::SniCallback => "SNI callback function",
...
fn get_protocol_value_type(protocol: Protocol) -> &'static str {
    match protocol {
        ...
        Protocol::ReqScript | Protocol::ResScript => "script_name",
        Protocol::ReqHeaders
        | Protocol::ResHeaders
        | Protocol::ReqCookies
        | Protocol::ResCookies
        ...
        Protocol::ForwardedFor => "ip_address",
        Protocol::Dns => "dns_server",
        Protocol::SniCallback => "callback_name",
        Protocol::Delete
        | Protocol::ReqCors
        | Protocol::ResCors
...
fn get_protocol_example(protocol: Protocol) -> &'static str {
    match protocol {
        ...
        Protocol::ForwardedFor => "forwardedFor://192.168.1.1",
        ...
        Protocol::SniCallback => "sniCallback://callback-function",
