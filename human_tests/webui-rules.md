...
### TC-WRU-17：规则内容使用 inline values（``` blocks）
...
### TC-WRU-18：Dynamic Island 显示活跃规则摘要
...
### TC-WRU-19：Dynamic Island 展开查看详情
...
### TC-WRU-21：Dynamic Island 变量冲突警告
...
### TC-WRU-22：通过 Import 按钮导入 .bifrost 文件
...
### TC-WRU-25：多规则文件管理 — 批量删除

**前置条件**：已通过 TC-WRU-24 多选了若干规则
...
### TC-WRU-35：Dynamic Island 显示合并规则内容
...
### TC-WRU-36：无活跃规则时 Dynamic Island 状态
